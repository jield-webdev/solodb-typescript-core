...
// iris
export { FileUploadEventState } from "./iris/interfaces/state";
export type { FileUploadEvent } from "./iris/interfaces/fileUploadEvent";

// chemical
export {
  ChemicalStandardProductEnum,
  ChemicalPhysicalStateEnum,
} from "./chemical/interfaces/chemical";
...
export type {
  EquipmentModule,
  EquipmentModuleType,
} from "./equipment/interfaces/equipment/equipmentModule";
...
export type {
  ValuesMap,
  ServiceReportCriterion,
} from "./service/interfaces/report/serviceReportCriterion";
